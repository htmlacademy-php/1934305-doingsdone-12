...
class ValidateEmailAuthTest extends TestCase
{
    public function testValidateEmailAuth()
    {
        ...
        $this->assertEquals("E-mail адрес слишком длинный", validateEmailAuth($superLongWord, false));
        ...
        $this->assertEquals("Пользователя с данным E-mail адресом не существует", validateEmailAuth("d_ivanov@mail.ru", false));
        $this->assertEquals("Пользователя с данным E-mail адресом не существует", validateEmailAuth("a_beliy@mail.ru", false));
    }
}
